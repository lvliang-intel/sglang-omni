...
MOSS_TD_CER_PERCENT_REF = 5.990212279140715
MOSS_TD_CER_NO_SPK_PERCENT_REF = 5.990212279140715
MOSS_TD_CER_NO_SPK_BELOW_50_PERCENT_REF: float | None = 5.091774084670031
MOSS_TD_N_ABOVE_50_CER_MAX: int | None = 31
MOSS_TD_CP_CER_PERCENT_REF = 13.971335960340664
MOSS_TD_CER_NO_SPK_CP_VALID_PERCENT_REF = 5.990212279140715
MOSS_TD_DELTA_CER_PERCENT_REF = 8.04309139443244
...
MOSS_TD_SPEAKER_TIMESTAMP_DER_PERCENT_REF: float | None = 22.455541605512416
MOSS_TD_CER_VALID_SAMPLES_MIN: int | None = 784
MOSS_TD_CP_CER_VALID_SAMPLES_MIN: int | None = 784
MOSS_TD_THROUGHPUT_QPS_REF = 39.21
MOSS_TD_LATENCY_MEAN_S_REF = 0.404
MOSS_TD_LATENCY_P95_S_REF = 0.954
MOSS_TD_RTF_MEAN_REF = 0.0388
MOSS_TD_RTF_P95_REF = 0.0626
...
AISHELL4_LONG_CER_PERCENT_MAX: float | None = 15.258728697985385
AISHELL4_LONG_CER_NO_SPK_PERCENT_MAX: float | None = 15.258728697985385
AISHELL4_LONG_CP_CER_PERCENT_MAX: float | None = 16.353072923018928
AISHELL4_LONG_DELTA_CER_PERCENT_MAX: float | None = 2.029581665576388
AISHELL4_LONG_SPEAKER_TIMESTAMP_DER_PERCENT_MAX: float | None = 12.388339964922126
AISHELL4_LONG_THROUGHPUT_QPS_MIN: float | None = 0.06
AISHELL4_LONG_LATENCY_MEAN_S_MAX: float | None = 187.819
AISHELL4_LONG_LATENCY_P95_S_MAX: float | None = 243.823
AISHELL4_LONG_RTF_MEAN_MAX: float | None = 0.0821
AISHELL4_LONG_RTF_P95_MAX: float | None = 0.107
